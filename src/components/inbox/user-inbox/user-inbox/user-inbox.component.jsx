                ...
                <div className="content">
                    <div className="user-inbox">
                        <div className="inbox-form">
                            <div className="inbox-form-btns">
                                <a href="/user-dashboard/user-inbox"><button type="button" className=" btn-inbox active">Inbox</button></a>
                                <a href="/user-dashboard/create-message"><button type="button" className="btn-create">Create Message</button></a>
                            </div>
