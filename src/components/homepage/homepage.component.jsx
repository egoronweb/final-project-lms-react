                ...
                <div className="content">
                    <div className="home-title">
                        <div className="home-title-content">
                            ...
                            <a href="/user-login"><span className="hometitle-link">Discover books that are new to you.</span></a>
                        </div>
                        <div className="home-buttons">
                            <a href="/user-login"><button type="button" className="btn btn-home">Login</button></a>
                            <a href="user-register"><button type="button" className="btn btn-home">Sign Up</button></a>
                        </div>
                    </div>
                </div>
