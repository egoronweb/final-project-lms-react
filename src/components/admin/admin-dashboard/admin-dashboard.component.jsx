                    ...
                    <div className="content">
                        <div className="dashboard">
                            ...
                            <div className="dashboard-btns">
                                <a href="/admin-dashboard/books-management"><button type="button" className="admin-dashboard-btn list-btn">Books Management</button></a>
                                <a href="/admin-dashboard/users-management"><button type="button" className="admin-dashboard-btn borrowed-btn">Users Management</button></a>
                                <a href="/admin-dashboard/admin-inbox"><button type="button" className="admin-dashboard-btn inbox-btn">Inbox</button></a>
                            </div>
                        </div>
                    </div>
