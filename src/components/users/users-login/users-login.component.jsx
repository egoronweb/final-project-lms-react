...
class UserLogin extends React.Component{
    ...
    userLogin = async e =>{
        ...
        const resp = await axios.post('http://127.0.0.1:8000/api/user-login');
                    ...
                    <div className="content-form">
                        <form onSubmit={this.userLogin} className="login-form">
                            <div className="form-btn-options">
                                <a href="/user-login"><button type="button" className="guest-option-btn active">Guest</button></a>
                                <a href="/admin-login"><button type="button" className="admin-option-btn">Admin</button></a>
                            </div>
                            <div className="login-title">Login as <span>Guest</span></div>
                            <div className="mb-3">
