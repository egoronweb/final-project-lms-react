...
class UserRegister extends React.Component{
    constructor(props){
        ...
        const history = useHistory();
            const resp = await axios.post('http://127.0.0.1:8000/api/user-register', this.state);
            if(resp.data.status === 200){
                swal("User Added Successfully", "You can now login!", "success");
            ...
            <div className="wrapper">
                 <nav className="top-nav-bar">
                    ...
                    <ul className="menu-texts">
                        ...
                        <li><a href="/user-register" className="active">Sign Up</a></li>
