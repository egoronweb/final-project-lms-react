        ...
        return(
            ...
            <div className="content">
                <div className="books">
                    ...
                    <div className="books-management-btns">
                        <button type="button" className="books-management-btn btn-primary btn-success">Create</button>
                        <button type="button" className="books-management-btn btn-primary btn-warning">Update</button>
                        <button type="button" className="books-management-btn btn-primary btn-danger">Delete</button>
                    </div>
